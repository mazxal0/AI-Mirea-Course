...
def summarize_dataset(
    ...
    - кол-во нулей для числовых признаков;
...
def compute_quality_flags(summary: DatasetSummary, missing_df: pd.DataFrame) -> Dict[str, Any]:
    ...
    score -= (
            flags["has_constant_columns"] * 0.3 +
            flags["has_high_cardinality_categoricals"] * 0.1 +
            zero_values_of_numeric_columns / len(summary.columns)
    )
